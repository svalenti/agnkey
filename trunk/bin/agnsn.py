...
if __name__ == "__main__":
    ...
    parser.add_option("-p", "--psf", dest="psf", default='', type='str', help='psf file \t\t\t %default')
    ...
    for imglong in imglist:
        if imglong:
            ...
            if skip == 0:
                ...
                if _interactive:
                    _z1, _z2, goon = agnkey.util.display_image(img + '.fits', 1, '', '', True, _xsize=1, _ysize=1)
                elif _show:
                    _z1, _z2, goon = agnkey.util.display_image(img + '.fits', 1, '', '', False)
            ...
            if skip == 0:
                ...
                if not _interactive or _size:
                    ...
                    while repeat == 'n':
                        ...
                        if not repeat:
                            ...
                            repeat = 'n'
                if _show:
                    _z11, _z22, good = agnkey.util.display_image('original.fits', 1, '', '', False, _xsize=.5,
                                                                 _ysize=.5)
                    z11, z22 = _z11, _z22
                if _interactive:
                    answ = 'y'
                ...
                while answ0 == 'n':
                    ...
                    if _show or _interactive:
                        _tmp1, _tmp2, goon = agnkey.util.display_image('original.fits', 1, z11, z22, False, _xcen=.25,
                    ...
                    if _show:
                        ...
                        _tmp1, _tmp2, goon = agnkey.util.display_image('sky.fits', 1, z11, z22, False, _xcen=.25,
                    ...
                    if _show:
                        iraf.tvmark(1, "tmptbl", autol='no', mark="none", inter='no', label='yes', txsize=2)
                        _tmp1, _tmp2, goon = agnkey.util.display_image('sn.fits', 1, z11, z22, False, _xcen=.75,
                                                                       _ycen=.25, _xsize=.3, _ysize=.3, _erase='no')
                    agnkey.util.delete("tmptbl")
                    ff = open('tmptbl', 'w')
                ...
                while answ0 == 'y':
                    ...
                    apori1, apori2, apori3, apmag1, apmag2, apmag3, fitmag, truemag, magerr, centx, centy, newmag = \
                        agnkey.agnsnoopy.manusn(img, psfimage, dmag0, apori1, apori2, apori3, apmag1, apmag2, apmag3,
                                                fitmag, truemag, magerr, centx, centy, z11, z22, midpt, _size,
                                                fwhm0, x1, y1, arterr)
                    try:
                ...
                for i in range(len(fitmag)):
                    ...
                    headers = {'PSFX' + str(i + 1): [str(centx[i] + x1 - 1), 'x pos psf mag'],
                               ...
                               'PSFMAG' + str(i + 1): [str(truemag[i]), 'psf magnitude'],
                ...
                try:
                    ...
                    agnkey.agnsqldef.updatevalue('dataredulco', 'psfy', centy[0] + y1 - 1,
                                                 string.split(img, '/')[-1] + '.fits')
                    agnkey.agnsqldef.updatevalue('dataredulco', 'apmag', apmag3[0],
                                                 string.split(img, '/')[-1] + '.fits')
                except:
                    print 'module mysqldef not found'
            else:
