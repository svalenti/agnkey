...
if __name__ == "__main__":
    ...
    for img in imglist:
        agnkey.agnabsphotdef.absphot(img, _field, _catalogue, _fix, _color, _rejection, _interactive, _type, _redo,
                                     _show, _cutmag, 'dataredulco', _calib)
