...
if __name__ == "__main__":
    ...
    for img in imglist:
        ...
        if len(pos0) >= 3:
            ...
            agnkey.agnsqldef.updatevalue('dataredulco', 'ZPNERR', float(std2),
                                         string.split(re.sub('sn2.', '', img), '/')[-1])
            ...
            if len(aa) > 0:
                ...
                if mag1 != 'INDEF':
                    ...
                    try:
                        agnkey.agnsqldef.updatevalue('dataredulco', 'appmagap1', float(mag1) + ZZ0,
                                                     string.split(re.sub('sn2.', '', img), '/')[-1])
                ...
                if mag2 != 'INDEF':
                    ...
                    try:
                        agnkey.agnsqldef.updatevalue('dataredulco', 'appmagap2', float(mag2) + ZZ0,
                                                     string.split(re.sub('sn2.', '', img), '/')[-1])
                ...
                if mag3 != 'INDEF':
                    ...
                    try:
                        agnkey.agnsqldef.updatevalue('dataredulco', 'appmagap3', float(mag3) + ZZ0,
                                                     string.split(re.sub('sn2.', '', img), '/')[-1])
