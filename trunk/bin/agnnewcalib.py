...
#                    raw_input('ddddd')
                ...
                iraf.noao.daophot.fitskypars.salgori = 'mean'  # 'median', default is 'mode'
                iraf.noao.daophot.fitskypars.annulus = a4
                iraf.noao.daophot.fitskypars.dannulus = a4
                iraf.noao.daophot.photpars.apertures = '%d,%d,%d' % (a2, a3, a4)
