...
################################################################################################
    ...
    data = agn_function.query(command)
    if data:
        ll={}
        for key in data[0]:
            ll[key] = []
    ...
    for jj,spectrum in enumerate(ll['namefile']):
        line0=''
        nnn = '../../AGNKEY/'+re.sub(workingdirectory,'',ll['directory'][jj])+str(re.sub(".fits",".png",spectrum))
        jjj=agn_function.grafico1(nnn,'50','300')+'</p>'
        line0=line0+'<td>'+str(ll['name'][jj])+'</td>'
        line0=line0+'<td>'+str(spectrum)+'</td>'
        line0=line0+'<td>'+jjj+'</td>'
        line0=line0+'<td> '+ agn_function.markasbad(str(ll['id'][jj]),str(ll['targid'][jj]),_user,'status','agnmissing.cgi')+'</td>'
        print '<tr>'+line0+'</tr>'
    print '</table>'
#################################################################################################
    ...
    for jj,spectrum in enumerate(ll['namefile']):
        line0=''
        nnn = '../../AGNKEY/'+re.sub(workingdirectory,'',ll['wdirectory'][jj])+str(re.sub(".fits",".png",spectrum))
        jjj=agn_function.grafico1(nnn,'150','150')+'</p>'
        line0=line0+'<td>'+str(ll['name'][jj])+'</td>'
